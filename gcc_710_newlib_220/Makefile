...
$(build_sh4_targets): extra_configure_args = --with-multilib-list=m4-single-only,m4-nofpu,m4 --with-endian=little --with-cpu=m4-single-only --disable-wchar_t --disable-long-long --disable-libstdcxx-dual-abi --disable-libada --disable-nls
